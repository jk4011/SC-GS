...
bash train_dfa.sh 4   "beagle_dog(s1)"            520      525    16      ${wandb_group_name} &&
bash train_dfa.sh 4   "beagle_dog(s1_24fps)"      190      215    32      ${wandb_group_name} &&
bash train_dfa.sh 4   "wolf(Howling)"             10       60     24      ${wandb_group_name} &&
bash train_dfa.sh 4   "bear(walk)"                110      140    16      ${wandb_group_name} &&
bash train_dfa.sh 4   "cat(run)"                  25       30     32      ${wandb_group_name} &

bash train_dfa.sh 5   "cat(walk_final)"           10       20     32      ${wandb_group_name} &&
...
bash train_dfa.sh 5   "duck(eat_grass)"           5        15     32      ${wandb_group_name} &

bash train_dfa.sh 0   "duck(swim)"                145      160    16      ${wandb_group_name} &&
...
bash train_dfa.sh 2   "panda(run)"                5        10     32      ${wandb_group_name} &&
bash train_dfa.sh 2   "lion(Run)"                 50       55     24      ${wandb_group_name} &&
bash train_dfa.sh 2   "duck(walk)"                200      230    16      ${wandb_group_name} &&
